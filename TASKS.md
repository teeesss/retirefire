...
- [x] **Features**:
    ...
    - [x] Multi-year conversion table with editable cells.
    - [x] Breakeven analysis (taxes paid now vs saved later).
    - [x] Source account selection (Traditional IRA vs 401k vs Taxable).
